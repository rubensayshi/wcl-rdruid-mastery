...
var REPARSE = true;
var BLIND_REPARSE_WINDOW = 5; // after this it requires a heal tick to trigger a reparse
var DEBUG = {
    _applyHot: false,
    _removeHot: false,
    source: false
...
Parser.prototype._deathEvent = function(event) {
    ...
    self.targets[event.targetID].tier204pcRejuv = false;
...
Parser.prototype._healEvent = function(event) {
    ...
    var isTier204pcRejuv = self.targets[event.targetID].tier204pcRejuv && event.ability.name === SPELLS.REJUV;
...
Parser.prototype._applyOrRefreshBuffEvent = function(event, isRefreshBuff) {
    ...
    // @TODO: germ
    // remove PotA attribution from target if a rejuv is refreshed
